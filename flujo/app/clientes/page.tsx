...
export default function ClientesPage() {
  ...
  return (
    <>
      <PageHeader
        title="Clientes" breadcrumb="Clientes"
      ...
      <DataTable columns={columns} data={clientes} searchKey="nombre" searchPlaceholder="Buscar por nombre, email..." onRowClick={(c) => openDrawer("customer", c)} />
    </>
  );
}
