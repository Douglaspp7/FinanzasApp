...
const nombres = [
  ...
  "Nicolás Castro", "Renata Jiménez", "Emilio Ruíz", "Antonella Núñez", "Tomás Mendoza",
...
export const clientes: Cliente[] = nombres.map((nombre, i) => {
  ...
  return {
    ...
    nombre,
    email: nombre.toLowerCase().replace(/ /g, ".").replace(/[áéíóú]/g, (c) => "aeiou"["áéíóú".indexOf(c)]) + "@email.com",
