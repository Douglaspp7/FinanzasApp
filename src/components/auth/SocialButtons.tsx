...
export function SocialButtons() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Button variant="outline" onClick={handleGoogle} loading={loadingGoogle} className="w-full">
      ...
      <Button variant="outline" onClick={handleApple} loading={loadingApple} className="w-full">
